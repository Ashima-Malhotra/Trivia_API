...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}/{}".format('postgres','user@localhost:5432', self.database_name)
    ...
    def test_422_sent_deleting_non_existing_question(self):
        res = self.client().delete('/questions/660')
        data = json.loads(res.data)
    ...
    def test_404_get_questions_by_category(self):
        res = self.client().get('/categories/trivia/questions/')
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 404)
        self.assertEqual(data["success"], False)
        self.assertEqual(data["message"], "resource not found")
